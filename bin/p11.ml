...
let parse_test (test_val, t_branch, f_branch) e =
  let remainder = e mod int_of_string test_val in
...
let parse_monkey line_block =
  ...
  | _ :: start_items :: op :: test_case :: t_branch :: f_branch :: _ ->
      ...
      let test =
        ...
        match slice with
        | test :: t_branch :: f_branch :: _ ->
            parse_test (test, t_branch, f_branch)
...
let monkey_business =
  let sorted_monkeys = round monkeys in
